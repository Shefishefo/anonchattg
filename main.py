...
#конфиг
BOT_TOKEN = '5157172731:AAGYcopQNYpPFJrrJvGVHpykj4B0hzhEP5I'#Токен бота
ADMIN_LIST = [1886432808] #Id админа
...
async def start(message : types.Message, state: FSMContext):
    ...
    await bot.send_message(message.chat.id, f'<b>👋 Привет! Это Анонимный чат Телеграма.</b>\n'
                                            ...
                                            f'<i>Удачного общения! Будьте вежливы к собеседникам.</i> https://t.me/babochkiii',reply_markup=mark_menu, parse_mode=types.ParseMode.HTML)
